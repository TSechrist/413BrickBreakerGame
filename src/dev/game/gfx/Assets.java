...
public class Assets {
    ...
    public static BufferedImage box1, box2, background, tank, ground, bullet, bullet34, menuScreen, powerup, gameover, poweruplives, objBox;
    ...
    public static void init(){
        ...
        objBox = ImageLoader.loadImage("/res/textures/objBox.jpg");
